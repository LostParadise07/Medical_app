...
class TempCard extends StatefulWidget {
  const TempCard({super.key});

  @override
  TemperatureChartState createState() => TemperatureChartState();
}

class TemperatureChartState extends State<TempCard> {
  List<FlSpot> spots = [
    FlSpot(1, 60),
    FlSpot(2, 90),
    FlSpot(3.5, 102),
  ...
  var nav = true;
  var tempStatus = "Temperature is Normal";
...
class _Rw extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      margin: EdgeInsets.only(top: t, left: 20, right: 20),
